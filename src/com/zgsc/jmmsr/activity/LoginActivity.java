...
//					DemoApplication.getInstance().setUserName(username);
					...
					//PreferenceUtils.getInstance(LoginActivity.this).setSettingUserNickName("齐天大圣");
					//PreferenceUtils.getInstance(LoginActivity.this).setSettingUserPic("file:///mnt/sdcard/Android/data/com.zgsc.jmmsr/ccxt%23sandbox/0c72fc0e1dcffe877b2d9fffe1a82cfc/image/123.jpg");
					//    file:///mnt/sdcard/Android/data/com.zgsc.jmmsr/test/321.jpg
					//PreferenceUtils.getInstance(LoginActivity.this).setSettingUserPic("file:///mnt/sdcard/Android/data/com.zgsc.jmmsr/test/321.jpg");
					runOnUiThread(new Runnable() {
						public void run() {
