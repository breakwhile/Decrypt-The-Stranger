...
public class GameView extends LinearLayout {
	...
	private void initGameView() {
		...
		setBackgroundColor(0xff9B30FF);//0xffbbada0
	...
	public void startGame() {
		...
		ChallengeActivity aty = ChallengeActivity.getMainActivity();
		aty.clearScore();
	...
	private void addRandomNum() {
		...
		if (emptyPoints.size() > 0) {
			...
			ChallengeActivity.getMainActivity().getAnimLayer()
				...
				for (int x1 = x + 1; x1 < Config.LINES; x1++) {
					if (cardsMap[x1][y].getNum() > 0) {
						...
						if (cardsMap[x][y].getNum() <= 0) {
							...
							ChallengeActivity.getMainActivity().addScore(
									cardsMap[x][y].getNum());
							merge = true;
						}
