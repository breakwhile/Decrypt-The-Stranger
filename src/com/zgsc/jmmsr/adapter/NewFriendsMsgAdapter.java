...
import com.zgsc.jmmsr.activity.BaseActivity;
import com.zgsc.jmmsr.activity.TestActivity;
			...
			if (msg.getStatus() == InviteMesageStatus.BEAGREED) {
				...
				holder.status.setOnClickListener(new OnClickListener() {
					...
					public void onClick(View v) {
						// 同意别人发的好友请求
						if (msg.getReason().startsWith("向你发起挑战")) {
							Intent i = new Intent(context,ChallengeActivity.class);
							//i.putExtra("userId", msg.getFrom());
							i.putExtra("userMsg", msg);
							String score = msg.getReason().substring(msg.getReason().indexOf(":") + 1, msg.getReason().length());
							i.putExtra("score", score);
							i.putExtra("mode", "acceptChallenge");
							((BaseActivity)context).startActivityForResult(i, 122);
