...
public class Constant {
	...
	//http连接
	//public static final String BASE_URL = "http://101.200.195.37:8088/zaina/";
	//public static final String BASE_URL = "http://jmmsr.xyz:8088/zaina/";
	public static final String BASE_URL = "http://27.159.30.8:8088/zaina/";
	
	//头像上传 暂时
	public static final String MY_HEAD_UP_URL = BASE_URL + "uphead.php";
	//社会化登录url
  ...
  //获取更新信息接口
    ...
    public static final String[] diming = {"尸魂界","樱花庄","西纳普斯","万事屋","理想乡","秋叶原","秋山澪","伊克西翁",
    	"乌尔兰特","布宜诺斯艾利斯","魔法之森","白玉楼","冥界","命莲寺","有顶天","地灵殿","月之都","八云之家","雾之湖",
    	"三途河","人间之里","永远亭","守失神社","醉泉乡","京都","秋叶原","新宿二丁目", "雁羽温泉", "矶月之森", "御石莊民宿"};
